...
export function summarizeStatus() {
  ...
  const runtimeFiles = [
    ...
    `${secretsDir}/openobserve-rum-client-token`,
    `${secretsDir}/openobserve-rum-ingest-token`,
    `${secretsDir}/openobserve-delivery-ops-ingest-token`,
    `${secretsDir}/rabbitmq-admin-username`,
    `${secretsDir}/rabbitmq-admin-password`,
    `${secretsDir}/rabbitmq-ingest-username`,
    `${secretsDir}/rabbitmq-ingest-password`,
    `${secretsDir}/rabbitmq-worker-username`,
    `${secretsDir}/rabbitmq-worker-password`,
    `${secretsDir}/rabbitmq-monitoring-username`,
    `${secretsDir}/rabbitmq-monitoring-password`,
    caKeyPath,
    leafKeyPath,
    caCertPath,
    leafCertPath,
