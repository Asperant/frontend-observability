...
// Stage 8 real OpenObserve RUM/browser-logs integration, requires
...
test.describe("Stage 8 OpenObserve RUM/browser-logs integration", () => {
  ...
  test("SDK import/init failure (dynamic import blocked) does not break the demo", async ({
    ...
    // The demo-frontend's own production build re-hashes this chunk's
