...
describe("evaluatePolicySample", () => {
  ...
  it("handles version-regression minimums, unknown versions, and recovery", () => {
    const policy = {
      ...basePolicy,
      id: "version-regression",
      metricId: "version_comparison",
      threshold: { absoluteStarterValue: 0.05, relativeStarterValue: 0.5 },
      sample: { minimumCurrent: 30, minimumBaseline: 30 },
      recoveryCondition: {
        absoluteDeltaBelowOrEqual: 0.02,
        relativeDeltaBelowOrEqual: 0.2,
