...
// Real OpenObserve RUM/browser-logs integration: talks to the
...
// full Chromium/Firefox coverage of this adapter's actual behavior (consent
// gating, no session replay, dynamic-import failure isolation) via the
// plain-HTTP, non-lab suite in playwright.config.js, which every accepted engine
// runs against a real — not mocked — @openobserve adapter.
export default defineConfig({
  testDir: "tests/e2e",
  testMatch: /openobserve-ingestion\.spec\.js/,
  fullyParallel: false,
