...
describe("validateRuntimeConfig", () => {
  ...
  it("rejects the removed balanced-profile compatibility alias", () => {
    const result = validateRuntimeConfig(
      loadFixture("runtime-config/invalid-legacy-balanced.json"),
    );
  ...
  it("rejects a config sending removed legacy allowedRoutes", () => {
    const result = validateRuntimeConfig(
  ...
  it("rejects a config missing sensitiveRoutes", () => {
    const result = validateRuntimeConfig(
